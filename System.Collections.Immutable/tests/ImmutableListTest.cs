...
namespace System.Collections.Immutable.Test
{
    public class ImmutableListTest : ImmutableListTestBase
    {
            ...
            for (int iOp = 0; iOp < operationCount; iOp++)
            {
                switch ((Operation)random.Next((int)Operation.Last))
                {
                    case Operation.Add:
                        ...
                        Debug.WriteLine(string.Format("Adding \"{0}\" to the list.", value));
                        expected.Add(value);
                    ...
                    case Operation.AddRange:
                        ...
                        Debug.WriteLine(string.Format("Adding {0} elements to the list.", inputLength));
                    ...
                    case Operation.Insert:
                        ...
                        value = random.Next();
                        Debug.WriteLine(string.Format("Adding \"{0}\" to position {1} in the list.", value, position));
                    ...
                    case Operation.InsertRange:
                        ...
                        Debug.WriteLine(string.Format("Adding {0} elements to position {1} in the list.", inputLength, position));
                    ...
                    case Operation.RemoveAt:
                        if (expected.Count > 0)
                        {
                            ...
                            Debug.WriteLine(string.Format("Removing element at position {0} from the list.", position));
                    ...
                    case Operation.RemoveRange:
                        ...
                        Debug.WriteLine(string.Format("Removing {0} elements starting at position {1} from the list.", inputLength, position));
        ...
        public void AddRangeBalanceTest()
        {
            ...
            Debug.WriteLine(string.Format("Random seed: {0}", randSeed));
            ...
            for (int i = 0; i < 128; i++)
            {
                ...
                Debug.WriteLine(string.Format("Adding {0} elements to the list", batchSize));
            ...
            Debug.WriteLine(string.Format("Adding {0} elements to the list", largeBatchSize));
