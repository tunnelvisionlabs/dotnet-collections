...
namespace System
{
    internal static class ExceptionResource
    {
        ...
        internal static readonly string Arg_HSCapacityOverflow = "HashSet capacity is too big.";
        internal static readonly string Arg_HTCapacityOverflow = "Hashtable's capacity overflowed and went negative. Check load factor, capacity and the current size of the table.";
        ...
        internal static readonly string Serialization_MissingKeys = "The keys for this dictionary are missing.";
